...
const scripts = {
	...
	lint: "eslint .",
	"lint:fix": "eslint --fix .",
	"gem-cli": "node ./bin/gem-cli.mjs",
	"gem-cli-bun": "bun --bun ./bin/gem-cli.mjs",
	prepack: "unbuild",
...
const commands = {
  "init-template": () => import('../chunks/index.mjs').then(_rDefault)
};
...
export { colors as a, runMain as b, consola as c, defineCommand as d, main as m, runCommand as r };
